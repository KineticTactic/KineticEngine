...
#define KE_PROFILE_END_SESSION() ::KE::Instrumentor::Get().EndSession()
#define KE_PROFILE_SCOPE(name) ::KE::InstrumentationTimer timer##__LINE__(name);
#define KE_PROFILE_FUNCTION()	KE_PROFILE_SCOPE(__FUNCSIG__)
#else
