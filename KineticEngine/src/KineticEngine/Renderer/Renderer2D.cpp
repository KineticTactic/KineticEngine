...
namespace KE {
	...
	// ----------------- SUB TEXTURED QUAD ----------------------------------
	void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& size, const Ref<SubTexture2D>& subTexture, float tilingFactor /*= 1.f*/, const glm::vec4& tintColor /*= glm::vec4(1.f)*/) {
		Renderer2D::DrawQuad({ position.x, position.y, 0.f }, size, subTexture, tilingFactor, tintColor);
	}

	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const Ref<SubTexture2D>& subTexture, float tilingFactor /*= 1.f*/, const glm::vec4& tintColor /*= glm::vec4(1.f)*/) {
		KE_PROFILE_FUNCTION();
